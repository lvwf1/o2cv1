var detailview = $.extend({}, $.fn.datagrid.defaults.view, {
    render: function (target, container, frozen) {
        ...
        for (var i = 0; i < rows.length; i++) {
            ...
            table.push('<td><img src="~/Content/images/icon01.png" width="22" height="22" alt=""></td>');
            table.push('<td><img src="~/Content/images/icon03.png" width="22" height="22" alt=""></td>');
            table.push('<td><img src="~/Content/images/icon02.png" width="22" height="22" alt=""></td>');
            table.push('<td><img src="~/Content/images/icon04.png" width="22" height="22" alt=""></td>');
            console.log('table.push td image')
