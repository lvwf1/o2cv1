;(function ($, undefined) {
    ...
    $.widget('eqjs.EasyChart', {
        ...
        init: function (dataTable, state, stateChangedCallback) {
            ...
            this.options.chartType = state.chartType || this.options.chartType;
        ...
        redraw: function () {
            if (this._dataView != null) {
                var chartOptions = {
                    width: "100%",
                    height: "100%",
                    chartArea: { width: this._chartTypes[this.options.chartType].chartAreaWidth || "50%" }
                };
